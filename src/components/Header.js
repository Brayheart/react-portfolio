...
const Portfolio = () => {
  return (
    <div className="bg-black text-white">
       ...
       */}
      {/* Hero Section */}
      <div className="flex flex-col-reverse text-center md:flex-row items-center md:items-start justify-center md:justify-between py-12 md:py-24 px-4 lg:px-8 mx-auto max-w-screen-lg">
        <div>
          ...
          <ul class="flex flex-row gap-3 animate-fade-up animate-delay-[600ms]">
            <li>

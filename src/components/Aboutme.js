    ...
    <div className="bg-black text-white sm:h-screen flex items-center justify-center">
      <div className="max-w-md mx-auto px-8 py-10 text-center sm:text-start">
        <div>
          ...
          <p className='animate-fade-up animate-delay-[800ms]'>Let's connect and explore how my journey can align with the future of technology and innovation.</p>
        </div>
      </div>
    </div>
  );

...
const Projects = () => {
  return (
    <div>
        <header class="flex flex-col gap-3 px-4 text-center sm:px-0 animate-fade-up sm:animate-delay-[100ms]">
        ...
        <nav class="container mx-auto bg-black grid items-center justify-center xl:grid-cols-3 gap-2 pt-2 lg:pt-5 pb-8 px-0 sm:px-2 text-center sm:text-start">
            <a target="_blank" rel="noreferrer" href="https://brayheart.github.io/Mountain-landing-page/" style={{Opacity: '1', Transform: 'none'}}>
                <article class="relative flex flex-row gap-4 items-center px-4 z-1 rounded-md h-[100px] w-[300px] sm:w-[400px] hover:bg-secondary/50 hover:bg-gray-800 hover:text-white transition duration-150 animate-fade-left sm:animate-delay-[200ms] animate-delay-[600ms]">
            ...
            <a target="_blank" rel="noreferrer" href="https://brayheart.github.io/ecommerce-page/" style={{Opacity: '1', Transform: 'none'}}>
                <article class="relative flex flex-row gap-4 items-center px-4 z-1 rounded-md h-[100px] w-[300px] sm:w-[400px] hover:bg-secondary/50 hover:bg-gray-800 hover:text-white transition duration-150 animate-fade-left sm:animate-delay-[300ms] animate-delay-[700ms]">
                    <header class="flex flex-col gap-1">
            ...
            <a target="_blank" rel="noreferrer" href="https://brayheart.github.io/huddle-landing-page/" style={{Opacity: '1', Transform: 'none'}}>
                <article class="relative flex flex-row gap-4 items-center px-4 z-1 rounded-md h-[100px] w-[300px] sm:w-[400px] hover:bg-secondary/50 hover:bg-gray-800 hover:text-white transition duration-150 animate-fade-left sm:animate-delay-[400ms] animate-delay-[800ms]">
                    <header>    
            ...
            <div className="mb-4 px-4 animate-fade-left sm:animate-delay-[500ms] animate-delay-[900ms]">
